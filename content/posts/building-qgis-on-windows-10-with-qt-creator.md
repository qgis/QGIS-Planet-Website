...
<p class="wp-block-paragraph">The environent configuration of the kit is:</p>
...
<p class="wp-block-paragraph">Note: I’m not really sure if all those variables are necessary, but that worked for me.</p>

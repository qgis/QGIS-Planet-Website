...
<figure class="figure text-center mb-4"><img alt="" class="figure-img img-fluid gallery-img" src="/img/subscribers/qfield/qfield-users-sit-down-we-need-to-talk-about-storage-access-on-android/unknown/image_qlYIdsGa.webp"/></figure>
...
<figure class="figure text-center mb-4"><img alt="" class="figure-img img-fluid gallery-img" src="/img/subscribers/qfield/qfield-users-sit-down-we-need-to-talk-about-storage-access-on-android/unknown/image_WIdXUJZa.webp"/></figure>
